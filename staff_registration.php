...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!isValidCNIC($cnic_number)) {
        ...
        if (!empty($staff_id)) {
            $sql = "UPDATE staff SET staff_name='$staff_name',  phone_number='$phone_number', address='$address', cnic_number='$cnic_number' WHERE staff_id='$staff_id'";
            ...
            $sql = "INSERT INTO staff (staff_name,  phone_number, address, cnic_number) 
                    VALUES ('$staff_name', '$phone_number', '$address', '$cnic_number')";
            if ($conn->query($sql) === TRUE) {
