...
$sections_to_display = !empty($allowed_sections) ? $allowed_sections : $all_sections;
?>
...
<body>
    <nav class="sidebar">
        <div class="logo">
            <img src="img/logo.jpg" alt="Dani's Fabrico Logo">
            <span class="logo-text">Dani's Fabrico</span>
        </div>
